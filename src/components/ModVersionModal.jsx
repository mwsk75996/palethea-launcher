...
function ModVersionModal({ project, gameVersion, loader, onSelect, onClose }) {
    ...
    useEffect(() => {
        loadVersions();
    }, [project.slug, gameVersion, loader]);
            ...
            <div className="version-modal" onClick={(e) => e.stopPropagation()}>
                <div className="version-modal-header">
                    <div className="header-info">
                        {project.icon_url && <img src={project.icon_url} alt="" className="project-icon-mini" />}
                        <div>
